...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_customTrip_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_customTrip_t qt_meta_stringdata_customTrip = {
    {
QT_MOC_LITERAL(0, 0, 10) // "customTrip"
...
const QMetaObject customTrip::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_customTrip.data,
      qt_meta_data_customTrip,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *customTrip::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_customTrip.stringdata0))
        return static_cast<void*>(const_cast< customTrip*>(this));
